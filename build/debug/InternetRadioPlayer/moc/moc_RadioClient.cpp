...
QT_MOC_LITERAL(3, 25, 7)
    ...
    "RadioClient\0sendCommand\0\0command"
};
...
void RadioClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RadioClient *_t = static_cast<RadioClient *>(_o);
        switch (_id) {
        ...
        {
            typedef void (RadioClient::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RadioClient::sendCommand)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void RadioClient::sendCommand(QString _t1)
{
